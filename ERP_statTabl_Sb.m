...
% % Update 
% % Individual subject TW input in "selected_TW" table

function [SPSS_tab_avg]=ERP_statTabl_Sb(selected_TW_Sbj,inData,anzChan,Subj,St,G)
...
for g=1:G % groups
    ...
    for s=1:Subj % subjects
       selected_TW=squeeze(selected_TW_Sbj(s,:,:,g));
